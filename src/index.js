...
export function from(timezone, date) {
...
export function to(timezone, date) {
  ...
  // use timezones offset to calculate new date, tz[0] is in minutes, so
  // multiply by 60000 (60 seconds * 10000 milliseconds)
...
export function factory(timezone) {
  if (!timezone) {
